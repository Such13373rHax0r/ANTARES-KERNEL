...
void setupRubbish() {
	*(uint64_t *)0x200 = 0x0000000000000000;
	*(uint64_t *)0x240 = 0x00CF9A000000FFFF;
	*(uint64_t *)0x280 = 0x00CF92000000FFFF;
	*(uint64_t *)0x2C0 = 0x00CFFA000000FFFF;
	*(uint64_t *)0x300 = 0x00CFF2000000FFFF;
